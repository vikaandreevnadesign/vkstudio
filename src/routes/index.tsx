...
const portfolio = [
  ...
  },
  {
    ...
    desc: "Гайд-лендинг по новостройкам с описанием проектов, планировок и подводных камней.",
...
const pricing = [
  {
    name: "Визитка",
    price: "5 000 ₽",
    tagline: "Аккуратный сайт о вас или бизнесе",
    features: [
      "До 4 секций",
  ...
  },
  {
    name: "Лендинг",
    price: "10 000 ₽",
    tagline: "Продающий одностраничник под услугу",
    features: [
  ...
  },
  {
    name: "С виджетами",
    price: "12 000 – 15 000 ₽",
    tagline: "Лендинг с формами, калькуляторами и интеграциями",
    features: [
      "Формы заявки + интеграция с Telegram",
      ...
      <section id="pricing" className="border-y border-border/50 bg-card/20">
        <div className="mx-auto max-w-6xl px-5 py-20 md:py-28">
          ...
          <p className="mt-8 text-center text-xs text-muted-foreground">
            * Квизы и тесты — отдельный мини-сайт: 3 000 – 5 000 ₽. Сложные проекты — по договорённости.
          </p>
        </div>
      </section>
