...
const portfolio = [
  {
    title: "Путь к себе",
    desc: "Многостраничный сайт энергокоуча и астролога: услуги, расчёты, формы записи. Атмосферный hero и мягкая подача.",
    tag: "Мульти-сайт",
    url: "http://ya-est.ru/",
    img: portfolioYaEst,
  },
  ...
  },
  {
    ...
    desc: "Информационный гайд-лендинг по новостройкам с прямыми кнопками связи в Telegram и WhatsApp.",
    tag: "Информационный лендинг",
...
const pricing = [
  {
    name: "Лендинг",
    price: "5 000 ₽",
    tagline: "Одностраничник под продажу или услугу",
    features: [
      "До 6 секций под задачу",
  ...
  {
    name: "Лендинг с формами",
    price: "8 900 ₽",
    tagline: "Продающий лендинг + сбор заявок",
    features: [
  ...
  {
    name: "Мульти-сайт / Квиз",
    price: "от 12 900 ₽",
    tagline: "Многостраничный сайт, квиз или презентация с расчётами",
    features: [
      "Несколько разделов или шагов с логикой",
      "Калькуляторы и интерактив",
      "Сбор лидов с ответами",
      "Дизайн под ваш бренд + домен",
      "Срок: 6–10 дней",
    ],
    cta: "Обсудить проект",
    highlight: false,
